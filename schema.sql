...
create table
  public.log_barrels (
    id bigint generated by default as identity,
    barrel_sku text null,
    quantity integer not null,
    price integer not null,
    bt_id bigint not null,
    ml_per_barrel integer not null,
    constraint log_barrels_pkey primary key (id),
    constraint log_barrels_bt_id_fkey foreign key (bt_id) references barrel_transactions (id)
  ) tablespace pg_default;

create table
  public.catalog_transactions (
    id bigint generated by default as identity,
    created_at timestamp with time zone not null default now(),
    tick integer not null default add_tick (now()),
    constraint catalog_transactions_pkey primary key (id)
  ) tablespace pg_default;
...
create table
  public.log_catalog (
    ...
    constraint log_catalog_pkey primary key (id),
    constraint log_catalog_ct_id_fkey foreign key (ct_id) references catalog_transactions (id)
  ) tablespace pg_default;
